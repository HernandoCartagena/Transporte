...
class RegistroRutaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val tvOrigen: TextView = view.findViewById(R.id.etNameRuta)
        val tvDestino: TextView = view.findViewById(R.id.etnamepasajero)
        val tvPrecio: TextView = view.findViewById(R.id.etdnipasajero)
        val tvSalida: TextView = view.findViewById(R.id.etCantBol)
